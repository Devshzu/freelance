...
import { validateForm } from "../../hook/formValidate.js";
...
function Signup() {
    ...
    return (
        <div className="App">
            <div className="lg:min-h-screen font-poppins bg-primary-red-500 bg-intro-mobile lg:bg-intro-desktop overflow-hidden bg-desktop-intro lg:flex">
                    ...
                    <div className="-mx-3 flex flex-wrap h-full">
                        <div className="px-3 bg-slate-950 py-20 lg:py-0 w-full lg:w-1/2 h-full flex flex-col justify-center items-center">
                            <div className="text-white space-y-8 my-auto xl:w-10/12">
                                <h1 className="text-4xl lg:text-5xl text-center lg:text-left font-bold">
                                    Learn to code by senior mentor
                                </h1>
                                <p>
                        ...
                        <div className="px-3 w-full lg:w-1/2 flex items-center">
                            <div className="space-y-8 w-full">
                                <h2 className="text-slate-500 text-center py-1 rounded-lg relative z-30 shadow-hard-gray">
                                ...
                                >
                                    <div className="p-8 text-sm space-y-6">
                                        ...
                                        <input
                                            ...
                                            className="bg-slate-900 hover:bg-primary-green-600 active:bg-primary-green-700 cursor-pointer font-semibold text-white py-4 rounded-lg text-center w-full uppercase border-b-[6px] border-primary-green-600"
                                        />
